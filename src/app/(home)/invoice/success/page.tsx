...
import { CheckCircle, AlertCircle, Clock, ArrowLeft, Receipt } from "lucide-react";
          ...
          <>
            {success ? (
              <div className="flex flex-col items-center">
                ...
                <h1 className="text-3xl font-bold text-center text-gray-800">Payment success</h1>
                <p className="mt-2 text-center text-gray-600 mb-6">Thank you for using our service</p>
                  ...
                  <div className="w-full mt-6 bg-gray-50 rounded-xl p-6 border border-gray-100">
                    <div className="flex justify-between items-start border-b border-gray-200 pb-4">
                      <div>
                        ...
                        <p className="text-sm text-gray-500 mt-1">Customer: #{invoice.customerId}</p>
                      </div>
                    ...
                    <div className="mt-6">
                      <h2 className="text-lg font-semibold text-gray-800 mb-3">Invoice details</h2>
                      <div className="space-y-3">
                        {invoice.appointment?.appointmentServices?.map((service: any) => (
                          <div key={service.appointmentServiceId} className="p-4 bg-white rounded-lg border border-gray-200 hover:shadow-md transition-shadow">
                            <div className="flex justify-between">
                              <h3 className="font-medium text-gray-800">{service.service.serviceName}</h3>
                              <p className="font-semibold text-green-600">${service.service.totalPrice}</p>
                            </div>
                            <p className="text-sm text-gray-600 mt-1">{service.service.description}</p>
                            <div className="flex items-center mt-2 text-sm text-gray-500">
                              <Clock size={16} className="mr-1" />
                              <span>{service.service.estimatedTime} phút</span>
                            </div>
                          </div>
                        ))}
                      </div>
                    ...
                    <div className="mt-6 pt-4 border-t border-gray-200">
                      <div className="flex justify-between items-center">
                        ...
                        <span className="text-2xl font-bold text-green-600">${invoice.totalAmount}</span>
                      </div>
              ...
              <div className="flex flex-col items-center">
                ...
                <h1 className="text-3xl font-bold text-center text-gray-800">Payment fail</h1>
